    ...
    return (
        <div className="absolute top-0 left-0" style={{ transform: `translate(${cursor.x}px, ${cursor.y}px)`}}>
            {cursorState.mode === CursorMode.Chat && (    
                <>
                    <CursorSVG color="#000"/>
                    <div className="absolute top-2 left-5 bg-blue px-4 py-2 text-sm leading-relaxed text-withe rounded-[20px]">
                    ...
                    <input className="z-10 w-60 border-none bg-transparent text-white placeholder-blue-300 outline-none"
                        ...
                        placeholder={cursorState.previousMessage ? "" : "Enter message"} 
